...
export default function Home() {
  return (
    <section className="max-w-6xl mx-auto py-12 px-6 text-white">
      ...
      <div className="grid grid-cols-[auto_1fr] gap-8 items-start mb-12">
        {/* LEFT: IMAGE */}
        <div>
          <img
            src="/Profile.jpg"
            alt="Mureed Sajjad"
            className="w-40 h-40 rounded-full shadow-lg border-4 border-blue-700 bg-white object-cover"
